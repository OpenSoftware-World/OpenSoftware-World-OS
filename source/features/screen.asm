...
.done_count:
	...
	mov bl, 00011111b		; White on red uygulama kutusu
...
os_dialog_box:
	...
	mov dl, 10 ; Start X position for box, centred on screen
...
.one_button:
	...
	mov dh, 14
	mov dl, 36 ; Cancel button, centred at bottom of box
	mov si, 8
	mov di, 15
	call os_draw_block

	mov dl, 39			; OK button, centred at bottom of box
	mov dh, 14
	call os_move_cursor
